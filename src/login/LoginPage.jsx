...
import {
  ...
  // RenderInstitutionButton, SocialAuthProviders,
  ThirdPartyAuthAlert,
...
class LoginPage extends React.Component {
  ...
  //         <Hyperlink className="p-0 mb-4 btn btn-link btn-sm text-body" destination={this.getEnterPriseLoginURL()}>
  ...
  //         <Skeleton className="mb-3 tpa-skeleton" height={30} count={2} />
  //       ) : (
  //         <>
  ...
  renderForm(
    ...
    return (
      <div className="p-8 bg-white rounded-xl">
        <h1 className="text-4xl font-bold text-center !text-primary">Нэвтрэх</h1>
        <p className="mt-3 mb-5 text-sm text-center text-muted">Тавтай морилоно уу, Та өөрийн хаягаар нэвтрэн орно уу</p>
