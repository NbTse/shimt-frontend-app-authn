  ...
  const renderForm = () => {
    ...
    return (
      <div className="p-8 bg-white rounded-xl">
        <h1 className="text-4xl font-bold text-center !text-primary mb-5">Бүртгүүлэх</h1>
        <Helmet>
        ...
        {autoSubmitRegisterForm && !errorCode.type ? (
          <div className="mt-5 text-center mw-xs">
          ...
          <div className="mt-3 mw-xs">
            ...
            <Form id="registration-form" name="registration-form">
              ...
              <StatefulButton
                ...
                type="submit"
                variant="brand"
                // className="mt-4 mb-4 register-stateful-button-width"
                className="my-btn-primary"
                state={submitState}
                labels={{
                  default: formatMessage(messages['create.account.button']),
                  pending: '',
                }}
